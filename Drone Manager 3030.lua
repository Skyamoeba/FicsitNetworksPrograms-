...
local By = ("Skyamoeba")
local Ver = ("1.0.0")
local UVer = {"1.0.0","4.0.0","0.3.6"} -- keep this here until you can pull pastes from Git / pastebin
local MVer = ("0.3.6")
local BFlag = 0
Page = 0
...
if BattLowFlag == 1 then else
 if Standby == true  then x = x + 15 gpu:setForeground(0,0,0,1) gpu:setBackground(1,1,0,1) write(x,y," Standby  ") end
